...
cp bin/ReleaseDLL/libsteamworks4j.dylib ../java-wrapper/src/main/resources/libsteamworks4j.dylib
...
cp bin/ReleaseDLL/libsteamworks4j-server.dylib ../server/src/main/resources/libsteamworks4j-server.dylib
...
cp bin/ReleaseDLL/libsteamworks4j-encryptedappticket.dylib ../server/src/main/resources/libsteamworks4j-encryptedappticket.dylib
