...
public class SteamUGC extends SteamInterface {
    ...
    */
    ...
    private static native long createQueryUGCDetailsRequest(long pointer, long[] publishedFileIDs,
                                                            int numPublishedFileIDs); /*
        ISteamUGC* ugc = (ISteamUGC*) pointer;
        UGCQueryHandle_t query = ugc->CreateQueryUGCDetailsRequest((PublishedFileId_t*) publishedFileIDs,
        numPublishedFileIDs);
        return (intp) query;
    */
...
//                                                      long[] publishedFileIDs, long maxEntries);
    ...
    */
    ...
    private static native boolean getQueryUGCKeyValueTag(long pointer, long query, int index, int keyValueTagIndex,
                                                         String[] keyAndValue); /*
        char key[1024];
        char value[1024];
    ...
    */
    ...
    private static native boolean setReturnAdditionalPreviews(long pointer, long query,
    ...
    */
    ...
    private static native long requestUGCDetails(long pointer, long callback, long publishedFileID,
                                                 int maxAgeSeconds); /*
        ISteamUGC* ugc = (ISteamUGC*) pointer;
        SteamUGCCallback* cb = (SteamUGCCallback*) callback;
    ...
    */
    ...
    private static native long startPlaytimeTracking(long pointer, long callback, long[] publishedFileIDs,
                                                     int numPublishedFileIDs); /*
        ISteamUGC* ugc = (ISteamUGC*) pointer;
        SteamUGCCallback* cb = (SteamUGCCallback*) callback;
    ...
    */
    ...
    private static native long stopPlaytimeTracking(long pointer, long callback, long[] publishedFileIDs,
                                                    int numPublishedFileIDs); /*
        ISteamUGC* ugc = (ISteamUGC*) pointer;
        SteamUGCCallback* cb = (SteamUGCCallback*) callback;
